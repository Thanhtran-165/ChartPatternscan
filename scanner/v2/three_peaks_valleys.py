...
class ThreePeaksValleysDetector:
    ...
    def scan_window(self, df: pd.DataFrame, pivots: Sequence[Pivot]) -> Optional[Dict[str, Any]]:
        ...
        # siết 13/08/2026: đáy/đỉnh trung gian nằm ngang trong ±2% (sách ECP ch45 — thước đo 81%)
...
def scan_symbol(
    ...
    *,
    ...
    for i in range(len(pivots) - 4):
        ...
        record.update(_evaluate_detection(df, record, lookahead=_registry_lookahead(record.get("pattern_key") or "three_falling_peaks")))
        out.append(record)
